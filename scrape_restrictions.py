...
with open("nswTravelRestriction.json", "w") as nswOutfile:
    json.dump(nswData, nswOutfile, indent = 2)
with open("ntTravelRestriction.json", "w") as ntOutfile:
    json.dump(ntData, ntOutfile, indent = 2)
with open("qldTravelRestriction.json", "w") as qldOutfile:
    json.dump(qldData, qldOutfile, indent = 2)
with open("saTravelRestriction.json", "w") as saOutfile:
    json.dump(saData, saOutfile, indent = 2)
with open("tasTravelRestriction.json", "w") as tasOutfile:
    json.dump(tasData, tasOutfile, indent = 2)
with open("vicTravelRestriction.json", "w") as vicOutfile:
    json.dump(vicData, vicOutfile, indent = 2)
with open("waTravelRestriction.json", "w") as waOutfile:
